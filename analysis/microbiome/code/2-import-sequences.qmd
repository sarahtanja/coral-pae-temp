...
Here I follow the QIIME2 [Casava 1.8 paired-end demultiplexed fastq](Casava 1.8 paired-end demultiplexed fastq) tutorial example on importing data, using the files provided to me by the Mr. DNA, Molecular Research.
...
In the `demux` folder is a `fastq.gz` file for The file name includes the sample identifier and should look like `4.Ea_S1_L001_R1_001.fastq.gz`. The underscore-separated fields in this file name are:
