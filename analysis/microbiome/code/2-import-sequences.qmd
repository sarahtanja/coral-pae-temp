...
Here I follow the QIIME2 Casava 1.8 paired-end demultiplexed fastq tutorial example on importing data, using the files provided to me by the Mr. DNA, Molecular Research.
